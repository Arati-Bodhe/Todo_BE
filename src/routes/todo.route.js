...
import { addTodo, completeTodo, deleteTodo, editTodo, fetchTodo, getCompletedTask } from "../controllers/todo.controller.js";
...
router.route("/complete-todo").post(completeTodo);
